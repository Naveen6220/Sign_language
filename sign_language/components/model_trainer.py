...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,) -> ModelTrainerArtifact:
        ...
        try:
            ...
            os.system(f"python yolov5/train.py --img 416 --batch {self.model_trainer_config.batch_size} --epochs {self.model_trainer_config.no_epochs} --data ../data.yaml --cfg ./models/custom_yolov5s.yaml --weights {self.model_trainer_config.weight_name} --name yolov5s_results --cache --nosave")
